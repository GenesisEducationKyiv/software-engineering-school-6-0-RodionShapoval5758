...
type GetSigningKeyResponse struct {
	...
	PublicKeyPem  []byte                 `protobuf:"bytes,2,opt,name=public_key_pem,json=publicKeyPem,proto3" json:"public_key_pem,omitempty"`
...
func (x *GetSigningKeyResponse) GetKid() string {
	if x != nil {
		return x.Kid
	}
	return ""
...
func (x *GetSigningKeyResponse) GetPublicKeyPem() []byte {
	if x != nil {
...
func (x *GetSigningKeyResponse) GetAlgorithm() string {
	if x != nil {
		return x.Algorithm
	}
	return ""
...
const file_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x12auth/v1/auth.proto\x12\aauth.v1\"\x16\n" +
	"\x14GetSigningKeyRequest\"m\n" +
	"\x15GetSigningKeyResponse\x12\x10\n" +
	"\x03kid\x18\x01 \x01(\tR\x03kid\x12$\n" +
	"\x0epublic_key_pem\x18\x02 \x01(\fR\fpublicKeyPem\x12\x1c\n" +
	"\talgorithm\x18\x03 \x01(\tR\talgorithm2]\n" +
	"\vAuthService\x12N\n" +
	"\rGetSigningKey\x12\x1d.auth.v1.GetSigningKeyRequest\x1a\x1e.auth.v1.GetSigningKeyResponseBCZAGithubReleaseNotificationAPI/services/auth/api/gen/authv1/auth/v1b\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	(*GetSigningKeyRequest)(nil),  // 0: auth.v1.GetSigningKeyRequest
	(*GetSigningKeyResponse)(nil), // 1: auth.v1.GetSigningKeyResponse
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	0, // 0: auth.v1.AuthService.GetSigningKey:input_type -> auth.v1.GetSigningKeyRequest
	1, // 1: auth.v1.AuthService.GetSigningKey:output_type -> auth.v1.GetSigningKeyResponse
